...
#It occurs roughly every four years. More specifically, a year is considered leap
#if it is either divisible by 4 but not by 100 or it is divisible by 400. 
#Write a program that asks the user for a year and replies with either leap year or not a leap year

year = int(input("Enter a year (e.g 1987, 1960, 2020): "))
